...
from apps.pokemon import models  # Module level not imported at top and unused skipcq: PYL-W0611, FLK-E402

# All the routes are moved to views.py
# ./manage.py -> import views
# ./models.py -> from __main__ import app, db
from apps.pokemon import views  # Module level not imported at top and unused skipcq: PYL-W0611, FLK-E402